    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (0 < pixelCenterX && pixelCenterX < DisplayCenterX) {
                directionX = "left";
            } else if (DisplayCenterX < DisplayCenterX && pixelCenterX < 640) {
                directionX = "right";
            } else if (0 < pixelCenterY && pixelCenterY < DisplayCenterY) {
                directionY = "up";
            } else if (DisplayCenterY < pixelCenterY && pixelCenterY < 480) {
                directionY = "down";
            }
